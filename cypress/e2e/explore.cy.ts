describe("Explore page", () => {
    ...
    it("should show 15 games and show more when show more is clicked", () => {
    ...
    it("should order by price", () => {
        ...
        cy.getByDataCy("game-card")
            .first()
            .within(() => {
                cy.findByText("Get Now").should("exist");
            });
        ...
        cy.getByDataCy("game-card")
            .first()
            .within(() => {
                cy.findByText("Get Now").should("not.exist");
            });
    });
    ...
    it("should return empty when no games match", () => {
        ...
        cy.findByText(/We not found any games with this filters/i).should("exist");
    });
});
